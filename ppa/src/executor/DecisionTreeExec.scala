...
object DecisionTreeExec {
  ...
  def main(args: Array[String]) {
    ...
    try {
      ...
      val params: HashMap[String, Any] = HashMap("attributes" -> attributes, "numClasses" -> 4, "impurity" -> "gini", "maxDepth" -> 5, "maxBins" -> 32)
      ...
      val imputationResult = algorithm.DecisionTree.run(idf, attributes(4), params, irisCallback)
      ...
      Logger.getLogger("appraisal").info("Algoritmo: Decision tree")
