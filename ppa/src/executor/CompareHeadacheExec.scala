...
object CompareHeadacheExec {
  ...
  def main(args: Array[String]) {
    ...
    try {
      ...
      var df = utility.Utility.loadDataset(spark, "headache.csv")
      ...
      def convertHeadacheToDouble(s: String): Double = {
        val headache = s match {
          case "continuing" => 1.0
          case "reduced"    => 2.0
          case "none"       => 3.0
          case _            => 0.0
      ...
      val headacheCallback = (i: String) => { convertHeadacheToDouble(i) }
      ...
      val decisionTreeImputationResult10 = algorithm.DecisionTree.run(idf10, attributes(4), params, headacheCallback)
      val decisionTreeImputationResult20 = algorithm.DecisionTree.run(idf20, attributes(4), params, headacheCallback)
      val decisionTreeImputationResult30 = algorithm.DecisionTree.run(idf30, attributes(4), params, headacheCallback)
      val decisionTreeImputationResult40 = algorithm.DecisionTree.run(idf40, attributes(4), params, headacheCallback)
      val decisionTreeImputationResult50 = algorithm.DecisionTree.run(idf50, attributes(4), params, headacheCallback)

      val randomForestImputationResult10 = algorithm.RandomForest.run(idf10, attributes(4), params, headacheCallback)
      val randomForestImputationResult20 = algorithm.RandomForest.run(idf20, attributes(4), params, headacheCallback)
      val randomForestImputationResult30 = algorithm.RandomForest.run(idf30, attributes(4), params, headacheCallback)
      val randomForestImputationResult40 = algorithm.RandomForest.run(idf40, attributes(4), params, headacheCallback)
      val randomForestImputationResult50 = algorithm.RandomForest.run(idf50, attributes(4), params, headacheCallback)

      val multilayerImputationResult10 = algorithm.MultilayerPerceptron.run(idf10, attributes(4), params, headacheCallback)
      val multilayerImputationResult20 = algorithm.MultilayerPerceptron.run(idf20, attributes(4), params, headacheCallback)
      val multilayerImputationResult30 = algorithm.MultilayerPerceptron.run(idf30, attributes(4), params, headacheCallback)
      val multilayerImputationResult40 = algorithm.MultilayerPerceptron.run(idf40, attributes(4), params, headacheCallback)
      val multilayerImputationResult50 = algorithm.MultilayerPerceptron.run(idf50, attributes(4), params, headacheCallback)

      val convertHeadacheToDoubleUdf = udf[Double, String](headacheCallback)
      ...
      val mdf = df
        ...
        .withColumn(attributes(4), convertHeadacheToDoubleUdf(df(attributes(4))))
