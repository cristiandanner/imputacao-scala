...
object MultilayerPerceptronExec {
  ...
  def main(args: Array[String]) {
    ...
    try {
      ...
      val params: HashMap[String, Any] = HashMap("attributes" -> attributes, "blockSize" -> 128, "seed" -> 1234L, "maxIter" -> 145)
      ...
      val imputationResult = algorithm.MultilayerPerceptron.run(idf, attributes(4), params, irisCallback)
      ...
      Logger.getLogger("appraisal").info("Algoritmo: Multilayer perceptron")
